...
class CryptoSignalEngine:
    ...
    def __init__(self) -> None:
        ...
        # Circuit breaker (initialised before TradeMonitor so it can be passed in)
        ...
        # Performance tracker (initialised before TradeMonitor so it can be passed in)
        ...
        # Select mode filter (ultra-selective signal gating)
